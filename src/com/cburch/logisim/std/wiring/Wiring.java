...
public class Wiring extends Library {
    ...
    private static FactoryDescription[] DESCRIPTIONS = {
            ...
            new FactoryDescription("Transistor",
                    ...
                    "Transistor"),
            new FactoryDescription("Relay", Strings.getter("relayComponent"),
                    "trans0.gif", "Relay"),
            new FactoryDescription("RelayLatching", Strings.getter("relayLatchingComponent"),
                    "trans0.gif", "RelayLatching"),
